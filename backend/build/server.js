/******/ (function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      (() =>
        __awaiter(void 0, void 0, void 0, function*() {
          yield mongoose.connect(url, { useNewUrlParser: true, useFindAndModify: false, useCreateIndex: true });
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const item_model_1 = __webpack_require__(3);
      const user_model_1 = __webpack_require__(4);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const vpnip_controller_1 = __webpack_require__(19);
      const app = express();
      app.use("/api/items", items_controller_1.default);
      app.use("/api/users", users_controller_1.default);
      app.use("/getip", vpnip_controller_1.default);
      app.use("/putip", vpnip_controller_1.default);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      router.route("/").get(config_1.authorize, (_, response) =>
        __awaiter(void 0, void 0, void 0, function*() {
          const items = yield item_model_1.default.find();
          return response.status(200).json(items);
        })
      );
      router.route("/").post(config_1.authorize, bodyParser.json(), (request, response) =>
        __awaiter(void 0, void 0, void 0, function*() {
          try {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const user_model_1 = __webpack_require__(4);
      passport.use(
        new passport_local_1.Strategy({ usernameField: "email" }, (username, password, done) =>
          __awaiter(void 0, void 0, void 0, function*() {
            try {
      ...
      router.route("/register").post(bodyParser.json(), (request, response) =>
        __awaiter(void 0, void 0, void 0, function*() {
          try {
            const user = new user_model_1.default();
      ...
      router.route("/profile").get(config_1.authorize, (request, response) =>
        __awaiter(void 0, void 0, void 0, function*() {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const bodyParser = __webpack_require__(2);
      const express = __webpack_require__(1);
      const vpnip_model_1 = __webpack_require__(20);
      const router = express.Router();
      router.route("/").get((request, response) =>
        __awaiter(void 0, void 0, void 0, function*() {
          const vpnips = yield vpnip_model_1.default.findOne({ source: request.query.source });
          return response.status(200).json(vpnips || {});
        })
      );
      router.route("/").put(bodyParser.json(), (request, response) =>
        __awaiter(void 0, void 0, void 0, function*() {
          try {
            const vpnip = new vpnip_model_1.default(request.body);
            vpnip_model_1.default.findOneAndUpdate({ source: request.body.source }, vpnip, { upsert: true }, (err, doc) => {
              if (err) {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const vpnIpSchema = new mongoose_1.Schema(vpnIpSchemaDef, {
        _id: false,
        toJSON: {
          transform: (doc, ret) => {
            delete ret._id;
      ...
      exports.default = mongoose_1.model("VpnIp", vpnIpSchema);
