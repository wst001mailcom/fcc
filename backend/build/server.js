...
const router = express.Router();
router.route("/").get((request, response) => __awaiter(this, void 0, void 0, function* () {
    const vpnips = yield vpnip_model_1.default.findOne({ "source": request.query.source });
    return response.status(200).json(vpnips || {});
}));
router.route("/").put(bodyParser.json(), (request, response) => __awaiter(this, void 0, void 0, function* () {
    try {
...
const vpnIpSchema = new mongoose_1.Schema(vpnIpSchemaDef, { _id: false, toJSON: {
        transform: (doc, ret) => {
            delete ret._id;
            delete ret.__v;
        }
